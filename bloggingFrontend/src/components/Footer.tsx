...
export default function Footer() {
    ...
    return (
        <div>
            <footer className={`${currentRoute==='/admin'?'hidden':'px-4 divide-y bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-100'}`}>
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                      <div className='flex  gap-2 items-center h-16 p-2'>
                              <img src={logo} alt='logo' className='size-12' />
                              <p className='text-2xl font-bold md-6 text-orange-500'>BBlogs</p>
                            </div>
                    </div>
